...
}struct value *global_SCOPEcalein_make_SPACEir_SPACEimport_ARG(struct value *arg0) {
struct value *result = value_make_record("calein_make_SPACEir_SPACEimport_ARG", 1);
result->u.record.fields[0] = arg0;
return result;
}
struct value *global_SCOPEcalein__SPACE_ARGis_SPACEan_SPACEir_SPACEimport(struct value *v) {
return value_make_boolean(v->kind == value_kind_record && !strcmp(v->u.record.type, "calein_make_SPACEir_SPACEimport_ARG"));
}struct value *global_SCOPEcalein_ir_SPACEof_SPACEir_SPACEimport_ARG(struct value *record) {
return value_record_field(record, "calein_make_SPACEir_SPACEimport_ARG", 0);
...
calein_false;
 ...
 0; }), local_vars.calein_tree);
value_add_reference(result);
value_remove_reference(local_vars.calein_child);value_remove_reference(local_vars.calein_tree);value_remove_reference(local_vars.calein_c);value_remove_reference(local_vars.calein_children);value_remove_reference(local_vars.calein_at_SPACEstart_SPACEof_SPACEliteral);value_remove_reference(local_vars.calein_again_SPACEin_SPACEsequence);value_remove_reference(local_vars.calein_again_SPACEin_SPACEliteral);value_remove_reference(local_vars.calein_in_SPACEescape);value_remove_reference(local_vars.calein_literal);value_remove_reference(local_vars.calein_again);value_remove_reference(local_vars.calein_at_SPACEstart_SPACEof_SPACEexpression);return result;
}
struct value *global_SCOPEcalein_parse_SPACEfile_ARG(struct value *calein_f){
...
value_add_reference(result);
value_remove_reference(local_vars.calein_items);value_remove_reference(local_vars.calein_ir_SPACEitems);value_remove_reference(local_vars.calein_import);value_remove_reference(local_vars.calein_f);value_remove_reference(local_vars.calein_file_SPACEname);value_remove_reference(local_vars.calein_args);value_remove_reference(local_vars.calein_ir_SPACEargs);value_remove_reference(local_vars.calein_tree);return result;
}
struct value *global_SCOPEcalein_ir_SPACEof_SPACEsyntax_SPACEtrees_ARG(struct value *calein_trees){
...
calein_false;
 ...
 0; }), global_SCOPEcalein_write_SPACEline_ARG(value_add_reference(value_make_string_from_c_string("#include \"caleinrtl.inc.c\""))), global_SCOPEcalein_write_SPACEline_ARG(value_add_reference(local_vars.calein_declarations)), global_SCOPEcalein_write_SPACEline_ARG(value_add_reference(local_vars.calein_definitions)), global_SCOPEcalein__COMMA_ARG_ARG(value_add_reference(local_vars.calein_initializers),value_add_reference(local_vars.calein_main)));
value_add_reference(result);
