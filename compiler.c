...
struct value *result = (({ while (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_index),value_add_reference(value_make_number(0))))))) {
(local_vars.calein_list = global_SCOPEcalein_second_ARG(value_add_reference(local_vars.calein_list)));
(local_vars.calein_index = global_SCOPEcalein__SPACE_ARG_DASH_ARG(value_add_reference(local_vars.calein_index),value_add_reference(value_make_number(1))));
...
struct value *result = (value_boolean_is_true(local_vars.calein_a) ? (local_vars.calein_a) : (local_vars.calein_b));
value_add_reference(result);
...
local_vars.calein_a = calein_a;
local_vars.calein_b = calein_b;
struct value *result = (value_boolean_is_true(local_vars.calein_a) ? (local_vars.calein_b) : (local_vars.calein_a));
value_add_reference(result);
value_remove_reference(local_vars.calein_b);value_remove_reference(local_vars.calein_a);return result;
}
struct value *global_SCOPEcalein__SPACE_ARGor_SPACE_SPACE_ARGor_ARG(struct value *calein_a, struct value *calein_b, struct value *calein_c){
...
local_vars.calein_a = calein_a;
local_vars.calein_b = calein_b;
struct value *result = ((local_vars.calein_found = value_add_reference(calein_false)), ({ while (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_a),value_add_reference(local_vars.calein_b)))))) {
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_a),value_add_reference(local_vars.calein_x)))) {
(local_vars.calein_found = calein_true);

} else {
calein_false;
}(local_vars.calein_a = global_SCOPEcalein__SPACE_ARG_PLUS_ARG(value_add_reference(local_vars.calein_a),value_add_reference(value_make_number(1))));
...
(local_vars.calein_i = global_SCOPEcalein__SPACE_ARG_PLUS_ARG(value_add_reference(local_vars.calein_i),value_add_reference(value_make_number(1))));
...
struct value *result = ((local_vars.calein_s = value_add_reference(value_make_string_from_c_string(""))), ({ while (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_number),value_add_reference(value_make_number(0))))))) {
...
(local_vars.calein_number = global_SCOPEcalein__SPACE_ARG_SLASH_ARG(value_add_reference(local_vars.calein_number),value_add_reference(value_make_number(10))));

}
 0; }), (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_s),value_add_reference(value_make_string_from_c_string("")))) ? (value_make_string_from_c_string("0")) : (global_SCOPEcalein_reverse_SPACEstring_ARG(value_add_reference(local_vars.calein_s)))));
value_add_reference(result);
...
struct value *result = ((local_vars.calein_tmp = value_add_reference(calein_false)), (value_boolean_is_true(calein_ungotten_SPACEcharacter) ? (((local_vars.calein_tmp = calein_ungotten_SPACEcharacter), (calein_ungotten_SPACEcharacter = calein_false))) : ((local_vars.calein_tmp = global_SCOPEcalein_read_SPACEcharacter()))), (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_tmp),value_add_reference(calein_new_SPACEline))) ? (((calein_line_SPACEnumber = global_SCOPEcalein__SPACE_ARG_PLUS_ARG(value_add_reference(calein_line_SPACEnumber),value_add_reference(value_make_number(1)))), (calein_column_SPACEnumber = value_make_number(1)))) : ((calein_column_SPACEnumber = global_SCOPEcalein__SPACE_ARG_PLUS_ARG(value_add_reference(calein_column_SPACEnumber),value_add_reference(value_make_number(1)))))), local_vars.calein_tmp);
value_add_reference(result);
...
local_vars.calein_c = calein_c;
struct value *result = ((calein_ungotten_SPACEcharacter = local_vars.calein_c), (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_new_SPACEline))) ? (((calein_line_SPACEnumber = global_SCOPEcalein__SPACE_ARG_DASH_ARG(value_add_reference(calein_line_SPACEnumber),value_add_reference(value_make_number(1)))), (calein_column_SPACEnumber = global_SCOPEcalein__SPACE_ARG_DASH_ARG(value_add_reference(value_make_number(0)),value_add_reference(value_make_number(1)))))) : ((calein_column_SPACEnumber = global_SCOPEcalein__SPACE_ARG_DASH_ARG(value_add_reference(calein_column_SPACEnumber),value_add_reference(value_make_number(1)))))));
value_add_reference(result);
value_remove_reference(local_vars.calein_c);return result;
}
struct value *global_SCOPEcalein_reverse_SPACElist_ARG(struct value *calein_list){
...
local_vars.calein_list = calein_list;
struct value *result = ((local_vars.calein_acc = value_add_reference(calein_false)), ({ while (value_boolean_is_true(local_vars.calein_list)) {
(local_vars.calein_acc = global_SCOPEcalein__COMMA_ARG_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(local_vars.calein_list))),value_add_reference(local_vars.calein_acc)));
(local_vars.calein_list = global_SCOPEcalein_second_ARG(value_add_reference(local_vars.calein_list)));
...
struct value *result = (({ while (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_n),value_add_reference(value_make_number(0))))))) {
global_SCOPEcalein_write_ARG(value_add_reference(calein_tab_SPACEstring));
(local_vars.calein_n = global_SCOPEcalein__SPACE_ARG_DASH_ARG(value_add_reference(local_vars.calein_n),value_add_reference(value_make_number(1))));
...
struct value *result = ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEa_SPACEliteral(value_add_reference(local_vars.calein_tree))) ? ((global_SCOPEcalein_indent_SPACE_SPACE_ARGtimes(value_add_reference(local_vars.calein_indent)), global_SCOPEcalein_write_ARG(value_add_reference(value_make_string_from_c_string("String: "))), global_SCOPEcalein_write_SPACEline_ARG(value_add_reference(global_SCOPEcalein_value_SPACEof_SPACEliteral_ARG(value_add_reference(local_vars.calein_tree)))))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEa_SPACEnumber(value_add_reference(local_vars.calein_tree))) ? ((global_SCOPEcalein_indent_SPACE_SPACE_ARGtimes(value_add_reference(local_vars.calein_indent)), global_SCOPEcalein_write_ARG(value_add_reference(value_make_string_from_c_string("Number: "))), global_SCOPEcalein_write_SPACEline_ARG(value_add_reference(global_SCOPEcalein_value_SPACEof_SPACEnumber_ARG(value_add_reference(local_vars.calein_tree)))))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEa_SPACEsequence(value_add_reference(local_vars.calein_tree))) ? ((global_SCOPEcalein_indent_SPACE_SPACE_ARGtimes(value_add_reference(local_vars.calein_indent)), global_SCOPEcalein_write_SPACEline_ARG(value_add_reference(value_make_string_from_c_string("Sequence:"))), (local_vars.calein_items = value_add_reference(global_SCOPEcalein_items_SPACEof_SPACEsequence_ARG(value_add_reference(local_vars.calein_tree)))), ({ while (value_boolean_is_true(local_vars.calein_items)) {
...
(local_vars.calein_items = global_SCOPEcalein_second_ARG(value_add_reference(local_vars.calein_items)));

}
 0; }))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEan_SPACEaction(value_add_reference(local_vars.calein_tree))) ? ((global_SCOPEcalein_indent_SPACE_SPACE_ARGtimes(value_add_reference(local_vars.calein_indent)), global_SCOPEcalein_write_ARG(value_add_reference(value_make_string_from_c_string("Action: "))), global_SCOPEcalein_write_SPACEline_ARG(value_add_reference(global_SCOPEcalein_name_SPACEof_SPACEaction_ARG(value_add_reference(local_vars.calein_tree)))), (local_vars.calein_args = value_add_reference(global_SCOPEcalein_arguments_SPACEof_SPACEaction_ARG(value_add_reference(local_vars.calein_tree)))), ({ while (value_boolean_is_true(local_vars.calein_args)) {
...
(local_vars.calein_args = global_SCOPEcalein_second_ARG(value_add_reference(local_vars.calein_args)));
...
global_SCOPEcalein_trim_SPACEright_ARG(value_add_reference(local_vars.calein_literal));
}if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGor_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_close_SPACEparen))),value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_close_SPACEbrace)))))) {
global_SCOPEcalein_unget_SPACEcharacter_ARG(value_add_reference(local_vars.calein_c));

} else {
calein_false;
}if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_length_ARG(value_add_reference(local_vars.calein_literal))),value_add_reference(value_make_number(0))))) {
(local_vars.calein_tree = local_vars.calein_first_SPACEchild);

} else {
(local_vars.calein_tree = global_SCOPEcalein_make_SPACEaction_SPACE_SPACE_ARGwith_SPACEarguments_ARG(value_add_reference(local_vars.calein_literal),value_add_reference(global_SCOPEcalein_reverse_SPACElist_ARG(value_add_reference(local_vars.calein_children)))));
}(local_vars.calein_again_SPACEin_SPACEaction = calein_false);

} else {
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACE_COMMA_ARG_SPACE_COMMA_ARG_SPACE_COMMA_ARG_SPACEor_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_quote),value_add_reference(calein_number_SPACEsigil),value_add_reference(calein_open_SPACEparen),value_add_reference(calein_open_SPACEbrace)))) {
(local_vars.calein_paren = global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_open_SPACEparen)));
if (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(local_vars.calein_paren)))) {
global_SCOPEcalein_unget_SPACEcharacter_ARG(value_add_reference(local_vars.calein_c));

} else {
calein_false;
}(local_vars.calein_child = global_SCOPEcalein_parse_ARG(value_add_reference(local_vars.calein_paren)));
if (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(local_vars.calein_child)))) {
...
(local_vars.calein_children = global_SCOPEcalein__COMMA_ARG_ARG(value_add_reference(global_SCOPEcalein__COMMA_ARG_ARG(value_add_reference(global_SCOPEcalein_length_ARG(value_add_reference(local_vars.calein_literal))),value_add_reference(local_vars.calein_child))),value_add_reference(local_vars.calein_children)));
if (value_boolean_is_true(local_vars.calein_paren)) {
(local_vars.calein_c = global_SCOPEcalein_get_SPACEcharacter());
if (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_close_SPACEparen)))))) {
...
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEwhitespace(value_add_reference(local_vars.calein_c)))) {
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_length_ARG(value_add_reference(local_vars.calein_literal))),value_add_reference(value_make_number(0))))) {
...
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_last_SPACEcharacter_SPACEof_ARG(value_add_reference(local_vars.calein_literal))),value_add_reference(calein_space)))) {
if (value_boolean_is_true(local_vars.calein_children)) {
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(local_vars.calein_children))))),value_add_reference(global_SCOPEcalein_length_ARG(value_add_reference(local_vars.calein_literal)))))) {
global_SCOPEcalein_append_SPACEcharacter_SPACE_SPACE_ARGto_ARG(value_add_reference(calein_space),value_add_reference(local_vars.calein_literal));
...
(local_vars.calein_c = global_SCOPEcalein_get_SPACEcharacter());
if (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(local_vars.calein_c)))) {
...
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_character_SPACEn)))) {
...
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_backslash)))) {
(local_vars.calein_in_SPACEescape = calein_true);

} else {
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_quote)))) {
(local_vars.calein_again_SPACEin_SPACEliteral = calein_false);
(local_vars.calein_tree = global_SCOPEcalein_make_SPACEliteral_ARG(value_add_reference(local_vars.calein_literal)));
if (value_boolean_is_true(local_vars.calein_at_SPACEstart_SPACEof_SPACEexpression)) {
(local_vars.calein_tree = global_SCOPEcalein_try_SPACEparse_SPACEaction_SPACEafter_ARG(value_add_reference(local_vars.calein_tree)));
...
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_number_SPACEsigil)))) {
(local_vars.calein_again_SPACEin_SPACEliteral = calein_true);
(local_vars.calein_literal = value_make_number(0));
(local_vars.calein_at_SPACEstart_SPACEof_SPACEliteral = calein_true);
while (value_boolean_is_true(local_vars.calein_again_SPACEin_SPACEliteral)) {
(local_vars.calein_c = global_SCOPEcalein_get_SPACEcharacter());
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGand_ARG(value_add_reference(local_vars.calein_at_SPACEstart_SPACEof_SPACEliteral),value_add_reference(global_SCOPEcalein_not_ARG(value_add_reference(local_vars.calein_c)))))) {
...
if (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEdigit(value_add_reference(local_vars.calein_c)))))) {
...
(local_vars.calein_tree = global_SCOPEcalein_make_SPACEnumber_ARG(value_add_reference(local_vars.calein_literal)));
if (value_boolean_is_true(local_vars.calein_at_SPACEstart_SPACEof_SPACEexpression)) {
(local_vars.calein_tree = global_SCOPEcalein_try_SPACEparse_SPACEaction_SPACEafter_ARG(value_add_reference(local_vars.calein_tree)));
...
(local_vars.calein_literal = global_SCOPEcalein__SPACE_ARG_PLUS_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARG_STAR_ARG(value_add_reference(local_vars.calein_literal),value_add_reference(value_make_number(10)))),value_add_reference(global_SCOPEcalein__SPACE_ARG_DASH_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_character_SPACE0)))));
(local_vars.calein_at_SPACEstart_SPACEof_SPACEliteral = calein_false);
}}
}

} else {
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_open_SPACEbrace)))) {
...
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_close_SPACEbrace)))) {
(local_vars.calein_again_SPACEin_SPACEsequence = calein_false);
(local_vars.calein_tree = global_SCOPEcalein_make_SPACEsequence_ARG(value_add_reference(global_SCOPEcalein_reverse_SPACElist_ARG(value_add_reference(local_vars.calein_children)))));
...
(local_vars.calein_children = global_SCOPEcalein__COMMA_ARG_ARG(value_add_reference(local_vars.calein_child),value_add_reference(local_vars.calein_children)));
...
if (value_boolean_is_true(local_vars.calein_c)) {
global_SCOPEcalein_unget_SPACEcharacter_ARG(value_add_reference(local_vars.calein_c));
(local_vars.calein_tree = global_SCOPEcalein_try_SPACEparse_SPACEaction_SPACEafter_ARG(value_add_reference(calein_false)));
...
local_vars.calein_c = calein_c;
struct value *result = ((calein_substitutions_SPACEfor_SPACEC_SPACEidentifiers = global_SCOPEcalein__COMMA_ARG_ARG(value_add_reference(global_SCOPEcalein__COMMA_ARG_ARG(value_add_reference(local_vars.calein_c),value_add_reference(local_vars.calein_str))),value_add_reference(calein_substitutions_SPACEfor_SPACEC_SPACEidentifiers))));
value_add_reference(result);
...
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(local_vars.calein_substitutions)))))))) {
...
(local_vars.calein_substitutions = global_SCOPEcalein_second_ARG(value_add_reference(local_vars.calein_substitutions)));
}
}
if (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(local_vars.calein_added)))) {
...
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_i),value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(local_vars.calein_args)))))))) {
...
calein_false;
 ...
 0; }), (value_boolean_is_true(local_vars.calein_args) ? (global_SCOPEcalein_append_SPACEstring_SPACE_SPACE_ARGto_ARG(value_add_reference(value_make_string_from_c_string("_ARG")),value_add_reference(local_vars.calein_ident))) : (calein_false)), local_vars.calein_ident);
value_add_reference(result);
...
struct value *result = ((local_vars.calein_string = value_add_reference(value_make_string_from_c_string("\""))), (local_vars.calein_i = value_add_reference(value_make_number(0))), (local_vars.calein_c = value_add_reference(calein_false)), ({ while (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_i),value_add_reference(global_SCOPEcalein_length_ARG(value_add_reference(local_vars.calein_literal)))))))) {
(local_vars.calein_c = global_SCOPEcalein_character_SPACEat_SPACE_SPACE_ARGof_ARG(value_add_reference(local_vars.calein_i),value_add_reference(local_vars.calein_literal)));
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_quote)))) {
...
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_c),value_add_reference(calein_new_SPACEline)))) {
...
struct value *result = ((local_vars.calein_found = value_add_reference(calein_false)), ({ while (value_boolean_is_true(local_vars.calein_list)) {
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(local_vars.calein_list))),value_add_reference(local_vars.calein_elem)))) {
...
struct value *result = ((local_vars.calein_found = value_add_reference(calein_false)), ({ while (value_boolean_is_true(local_vars.calein_alist)) {
if (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(local_vars.calein_alist))))),value_add_reference(local_vars.calein_key)))) {
(local_vars.calein_found = global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(local_vars.calein_alist)))));
(local_vars.calein_alist = calein_false);

} else {
(local_vars.calein_alist = global_SCOPEcalein_second_ARG(value_add_reference(local_vars.calein_alist)));
}
}
 0; }), local_vars.calein_found);
value_add_reference(result);
...
local_vars.calein_msg = calein_msg;
struct value *result = (global_SCOPEcalein_write_ARG(value_add_reference(value_make_string_from_c_string("compile error: "))), global_SCOPEcalein_write_SPACEline_ARG(value_add_reference(local_vars.calein_msg)), (calein_continue = calein_false));
value_add_reference(result);
value_remove_reference(local_vars.calein_msg);return result;
}
struct value *global_SCOPEcalein_emit_SPACE_SPACE_ARGto_SPACE_SPACE_ARGin_SPACE_SPACE_ARGwith_SPACEscope_ARG(struct value *calein_ir, struct value *calein_out, struct value *calein_context, struct value *calein_scope){
...
local_vars.calein_context = calein_context;
local_vars.calein_scope = calein_scope;
struct value *result = ((local_vars.calein_args = value_add_reference(calein_false)), (local_vars.calein_var_SPACEscope = value_add_reference(calein_false)), (local_vars.calein_sep = value_add_reference(calein_false)), (local_vars.calein_name = value_add_reference(calein_false)), (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEan_SPACEir_SPACEcall(value_add_reference(local_vars.calein_ir))) ? (((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEan_SPACEevaluation(value_add_reference(local_vars.calein_context))) ? (((local_vars.calein_args = global_SCOPEcalein_arguments_SPACEof_SPACEir_SPACEcall_ARG(value_add_reference(local_vars.calein_ir))), (local_vars.calein_name = global_SCOPEcalein_name_SPACEof_SPACEir_SPACEcall_ARG(value_add_reference(local_vars.calein_ir))), (local_vars.calein_var_SPACEscope = global_SCOPEcalein_lookup_SPACE_SPACE_ARGin_ARG(value_add_reference(local_vars.calein_name),value_add_reference(calein_variable_SPACElist))), (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGor_ARG(value_add_reference(local_vars.calein_args),value_add_reference(global_SCOPEcalein_not_ARG(value_add_reference(local_vars.calein_var_SPACEscope))))) ? (((local_vars.calein_function_SPACEinfo = value_add_reference(global_SCOPEcalein_lookup_SPACE_SPACE_ARGin_ARG(value_add_reference(local_vars.calein_name),value_add_reference(calein_function_SPACElist)))), (value_boolean_is_true(local_vars.calein_function_SPACEinfo) ? ((local_vars.calein_name = global_SCOPEcalein_first_ARG(value_add_reference(local_vars.calein_function_SPACEinfo)))) : ((local_vars.calein_name = global_SCOPEcalein_concat_SPACE_SPACE_ARGand_ARG(value_add_reference(calein_global_SPACEscope),value_add_reference(global_SCOPEcalein_concat_SPACE_SPACE_ARGand_ARG(value_add_reference(value_make_string_from_c_string("_SCOPE")),value_add_reference(local_vars.calein_name))))))), global_SCOPEcalein_append_SPACEstring_SPACE_SPACE_ARGto_ARG(value_add_reference(local_vars.calein_name),value_add_reference(local_vars.calein_out)), global_SCOPEcalein_append_SPACEstring_SPACE_SPACE_ARGto_ARG(value_add_reference(value_make_string_from_c_string("(")),value_add_reference(local_vars.calein_out)), (local_vars.calein_sep = value_make_string_from_c_string("")), (value_boolean_is_true(local_vars.calein_function_SPACEinfo) ? ((value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(local_vars.calein_function_SPACEinfo))),value_add_reference(calein_global_SPACEscope))))) ? ((global_SCOPEcalein_append_SPACEstring_SPACE_SPACE_ARGto_ARG(value_add_reference(value_make_string_from_c_string("&local_vars")),value_add_reference(local_vars.calein_out)), (local_vars.calein_sep = value_make_string_from_c_string(",")))) : (calein_false))) : (calein_false)), ({ while (value_boolean_is_true(local_vars.calein_args)) {
...
global_SCOPEcalein_append_SPACEstring_SPACE_SPACE_ARGto_ARG(value_add_reference(value_make_string_from_c_string(");")),value_add_reference(local_vars.calein_out));
(local_vars.calein_vars = global_SCOPEcalein_second_ARG(value_add_reference(local_vars.calein_vars)));

} else {
(local_vars.calein_vars = calein_false);
}
}
 0; }), global_SCOPEcalein_append_SPACEstring_SPACE_SPACE_ARGto_ARG(value_add_reference(value_make_string_from_c_string("return result;\n}\n")),value_add_reference(local_vars.calein_out))))), (calein_variable_SPACElist = local_vars.calein_old_SPACEvariable_SPACElist))) : (calein_false)), (calein_function_SPACElist = local_vars.calein_old_SPACEfunction_SPACElist))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEan_SPACEir_SPACEsequence(value_add_reference(local_vars.calein_ir))) ? (((local_vars.calein_items = value_add_reference(global_SCOPEcalein_items_SPACEof_SPACEir_SPACEsequence_ARG(value_add_reference(local_vars.calein_ir)))), (local_vars.calein_expected_SPACEsep = value_add_reference(value_make_string_from_c_string(""))), (local_vars.calein_old_SPACElength = value_add_reference(calein_false)), (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_context),value_add_reference(calein_expression_SPACEcontext))) ? (((local_vars.calein_expected_SPACEsep = value_make_string_from_c_string(", ")), global_SCOPEcalein_append_SPACEstring_SPACE_SPACE_ARGto_ARG(value_add_reference(value_make_string_from_c_string("(")),value_add_reference(local_vars.calein_out)))) : (calein_false)), (local_vars.calein_sep = local_vars.calein_expected_SPACEsep), (local_vars.calein_old_SPACElength = global_SCOPEcalein_length_ARG(value_add_reference(local_vars.calein_out))), ({ while (value_boolean_is_true(local_vars.calein_items)) {
if (value_boolean_is_true(global_SCOPEcalein_not_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(local_vars.calein_old_SPACElength),value_add_reference(global_SCOPEcalein_length_ARG(value_add_reference(local_vars.calein_out)))))))) {
global_SCOPEcalein_append_SPACEstring_SPACE_SPACE_ARGto_ARG(value_add_reference(local_vars.calein_sep),value_add_reference(local_vars.calein_out));

} else {
calein_false;
}(local_vars.calein_old_SPACElength = global_SCOPEcalein_length_ARG(value_add_reference(local_vars.calein_out)));
...
local_vars.calein_items = 0;
local_vars.calein_tree = calein_tree;
struct value *result = ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEan_SPACEaction(value_add_reference(local_vars.calein_tree))) ? (((local_vars.calein_ir_SPACEargs = value_add_reference(calein_false)), (local_vars.calein_args = value_add_reference(global_SCOPEcalein_arguments_SPACEof_SPACEaction_ARG(value_add_reference(local_vars.calein_tree)))), (value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_name_SPACEof_SPACEaction_ARG(value_add_reference(local_vars.calein_tree))),value_add_reference(value_make_string_from_c_string("define procedure  to do")))) ? (global_SCOPEcalein_make_SPACEir_SPACEprocedure_SPACE_SPACE_ARGwith_SPACEbody_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(0)))))),value_add_reference(global_SCOPEcalein_compile_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(1)))))))))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_name_SPACEof_SPACEaction_ARG(value_add_reference(local_vars.calein_tree))),value_add_reference(value_make_string_from_c_string("define variable  with initial value")))) ? (global_SCOPEcalein_make_SPACEir_SPACEvariable_SPACE_SPACE_ARGwith_SPACEinitial_SPACEvalue_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(0)))))),value_add_reference(global_SCOPEcalein_compile_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(1)))))))))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_name_SPACEof_SPACEaction_ARG(value_add_reference(local_vars.calein_tree))),value_add_reference(value_make_string_from_c_string("set  to")))) ? (global_SCOPEcalein_make_SPACEir_SPACEassignment_SPACE_SPACE_ARGwith_SPACEvalue_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(0)))))),value_add_reference(global_SCOPEcalein_compile_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(1)))))))))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_name_SPACEof_SPACEaction_ARG(value_add_reference(local_vars.calein_tree))),value_add_reference(value_make_string_from_c_string("if  then  else")))) ? (global_SCOPEcalein_make_SPACEir_SPACEif_SPACE_SPACE_ARGthen_SPACE_SPACE_ARGelse_ARG(value_add_reference(global_SCOPEcalein_compile_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(0)))))))),value_add_reference(global_SCOPEcalein_compile_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(1)))))))),value_add_reference(global_SCOPEcalein_compile_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(2)))))))))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEequal_SPACEto_ARG(value_add_reference(global_SCOPEcalein_name_SPACEof_SPACEaction_ARG(value_add_reference(local_vars.calein_tree))),value_add_reference(value_make_string_from_c_string("while  do")))) ? (global_SCOPEcalein_make_SPACEir_SPACEwhile_SPACE_SPACE_ARGwith_SPACEbody_ARG(value_add_reference(global_SCOPEcalein_compile_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(0)))))))),value_add_reference(global_SCOPEcalein_compile_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein__SPACE_ARGat_ARG(value_add_reference(local_vars.calein_args),value_add_reference(value_make_number(1)))))))))) : ((({ while (value_boolean_is_true(local_vars.calein_args)) {
(local_vars.calein_ir_SPACEargs = global_SCOPEcalein__COMMA_ARG_ARG(value_add_reference(global_SCOPEcalein_compile_ARG(value_add_reference(global_SCOPEcalein_second_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(local_vars.calein_args))))))),value_add_reference(local_vars.calein_ir_SPACEargs)));
(local_vars.calein_args = global_SCOPEcalein_second_ARG(value_add_reference(local_vars.calein_args)));

}
 0; }), global_SCOPEcalein_make_SPACEir_SPACEcall_SPACE_SPACE_ARGwith_SPACEarguments_ARG(value_add_reference(global_SCOPEcalein_C_SPACEident_SPACEfor_SPACEaction_ARG(value_add_reference(local_vars.calein_tree))),value_add_reference(global_SCOPEcalein_reverse_SPACElist_ARG(value_add_reference(local_vars.calein_ir_SPACEargs))))))))))))))))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEa_SPACEsequence(value_add_reference(local_vars.calein_tree))) ? (((local_vars.calein_ir_SPACEitems = value_add_reference(calein_false)), (local_vars.calein_items = value_add_reference(global_SCOPEcalein_items_SPACEof_SPACEsequence_ARG(value_add_reference(local_vars.calein_tree)))), ({ while (value_boolean_is_true(local_vars.calein_items)) {
(local_vars.calein_ir_SPACEitems = global_SCOPEcalein__COMMA_ARG_ARG(value_add_reference(global_SCOPEcalein_compile_ARG(value_add_reference(global_SCOPEcalein_first_ARG(value_add_reference(local_vars.calein_items))))),value_add_reference(local_vars.calein_ir_SPACEitems)));
(local_vars.calein_items = global_SCOPEcalein_second_ARG(value_add_reference(local_vars.calein_items)));

}
 0; }), global_SCOPEcalein_make_SPACEir_SPACEsequence_ARG(value_add_reference(global_SCOPEcalein_reverse_SPACElist_ARG(value_add_reference(local_vars.calein_ir_SPACEitems)))))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEa_SPACEnumber(value_add_reference(local_vars.calein_tree))) ? ((global_SCOPEcalein_make_SPACEir_SPACEnumber_ARG(value_add_reference(global_SCOPEcalein_value_SPACEof_SPACEnumber_ARG(value_add_reference(local_vars.calein_tree)))))) : ((value_boolean_is_true(global_SCOPEcalein__SPACE_ARGis_SPACEa_SPACEliteral(value_add_reference(local_vars.calein_tree))) ? ((global_SCOPEcalein_make_SPACEir_SPACEliteral_ARG(value_add_reference(global_SCOPEcalein_C_SPACEstring_SPACEfor_SPACEliteral_ARG(value_add_reference(global_SCOPEcalein_value_SPACEof_SPACEliteral_ARG(value_add_reference(local_vars.calein_tree)))))))) : (global_SCOPEcalein_compile_SPACEerror_ARG(value_add_reference(value_make_string_from_c_string("unsupported kind of tree"))))))))))));
value_add_reference(result);
...
(calein_tree = global_SCOPEcalein_parse_ARG(value_add_reference(calein_true)));
if (value_boolean_is_true(calein_tree)) {
(calein_ir = global_SCOPEcalein_compile_ARG(value_add_reference(calein_tree)));
